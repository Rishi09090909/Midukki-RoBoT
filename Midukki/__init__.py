...
class Configs(object):
    ...
    SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/ipopcornofficialgroup')
    ...
    # other
    DONATE_LINKS = environ.get("DONATION_LINK", "https://tools.apgy.in/upi/Rk_botz/8757081330@paytm/")
